  ...
  <div className="border-b border-border bg-background px-4 py-4 sm:px-8 sm:py-6">
    <div className="flex items-center justify-between gap-4">
      <div className="min-w-0">
        ...
        {description && <p className="mt-1 text-sm text-muted-foreground hidden sm:block">{description}</p>}
      </div>
      {actions && <div className="shrink-0">{actions}</div>}
    </div>
    {description && <p className="mt-2 text-sm text-muted-foreground sm:hidden">{description}</p>}
  </div>
);
